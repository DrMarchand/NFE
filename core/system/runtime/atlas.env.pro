...
ATLAS_BRIDGE="External Bridge"

# Supply operational values through private runtime configuration or an
# approved secret-management / infrastructure-registry boundary.
