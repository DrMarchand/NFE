...
Repository placement, operation, DBA association, and publisher credit do not transfer copyright. Existing licenses, prior grants, and third-party notices remain in effect.

A symbol or name is not registration evidence. Mark status, authorship, copyright ownership, licensing, and publisher status require the applicable work-specific evidence.
